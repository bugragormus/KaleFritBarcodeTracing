            ...
            <div class="page-header-modern">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <p class="page-subtitle-modern">Granilya firmasındaki bilgileri güncelleyin</p>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{ route('granilya.firma.index') }}" class="btn-modern btn-secondary-modern">
            ...
            <div class="card-modern">
                <div class="card-header-modern">
                    ...
                    <p class="card-subtitle-modern">
                        Lütfen firma bilgilerindeki değişiklikleri yapıp kaydedin
                    </p>
                </div>
                
                <div class="card-body-modern">
                    <form class="form" method="POST" action="{{ route('granilya.firma.update', $firma->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-6">
