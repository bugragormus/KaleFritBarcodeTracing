...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Yeni Firma Ekle</li>
@endsection
        ...
        <div class="container-fluid">
            ...
            <div class="page-header-modern">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <p class="page-subtitle-modern">Granilya sistemine yeni bir firma ekleyin</p>
                    </div>
            ...
            <div class="card-modern">
                ...
                <div class="card-body-modern">
                    <form class="form" method="POST" action="{{ route('granilya.firma.store') }}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
