...
@section('styles')
    <style>
        body, .main-content, .modern-company-edit {
        ...
        <div class="container-fluid">
            ...
            <div class="page-header-modern">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <p class="page-subtitle-modern">{{ $company->name }} firmasının bilgilerini güncelleyin</p>
                    </div>
            ...
            <div class="card-modern">
                ...
                <div class="card-body-modern">
                    <form class="form" method="POST" action="{{ route('company.update', ['firma' => $company->id]) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-6">
