...
@section('styles')
    <style>
        body, .main-content, .modern-stock-create {
        ...
        <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h1 class="page-title-modern">
                            <i class="fas fa-plus-circle"></i> Yeni Stok Girişi
                        </h1>
                        <p class="page-subtitle-modern">Sisteme yeni bir stok ekleyin</p>
                    </div>
            ...
            <div class="card-modern">
                ...
                <div class="card-body-modern">
                    <form class="form" method="POST" action="{{ route('stock.store') }}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
