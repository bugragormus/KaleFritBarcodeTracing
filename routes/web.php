...
Route::get('/dashboard/export-kiln-performance', [App\Http\Controllers\DashboardController::class, 'exportKilnPerformance'])->name('dashboard.export-kiln-performance')->middleware('auth');
